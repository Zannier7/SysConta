...
<html>
    ...
    <div id="yesData">
        ...
        <button onclick="sendDiario()" style="color: white;margin-left: 7%;" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent" id="sdiario">
            Registrar en Libro Diario
        </button>
        <button onclick="mod(4, 0, 0)" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--primary" style="color: white;float: right;margin-right: 7%;">
            Totales
        </button>
    </div>
    ...
    <input type="hidden" id="totR">
    <input type="hidden" id="totD">
    <input type="hidden" id="totA">
    <input type="hidden" id="totT">
    <input type="hidden" id="totI">
    <script>
